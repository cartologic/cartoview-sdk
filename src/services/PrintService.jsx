...
import { default as OlTileGrid } from 'ol/tilegrid'
        ...
        if (source instanceof OSM) {
            ...
            let layerObj = {
                ...
                resolutions: [156543.03390625, 78271.516953125,
                    ...
                    0.037322767712175846, 0.018661383856087923,
            ...
            let _tileGrid = OlTileGrid.createXYZ({
            ...
            let layerObj = {
                ...
                maxExtent: [-20037508.3392, -20037508.3392,
                    20037508.3392, 20037508.3392],
                customParams,
                tileOrigin: _tileGrid.getOrigin(),
                tileOriginCorner: 'bl',
